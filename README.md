...
Extract hidden or indirect clues
Use OSINT methodologies to trace real-world data
Correlate multiple pieces of information to reach a final answer

Unlike basic OSINT tasks, this challenge emphasizes:

Attention to small visual details
...
The name of the place where the trip occurred
The name of the person who sent the image
The exact date of the trip (format: MM/DD/YYYY)
The number of people who participated in the trip
...
The image acts as the primary evidence
Hidden details may include:
Background landmarks
Environmental clues
Metadata (EXIF data)
Social media traces
The description provides subtle hints but avoids direct guidance
...
Image forensics & reverse image search
...
Hard → Insane (depending on approach)
